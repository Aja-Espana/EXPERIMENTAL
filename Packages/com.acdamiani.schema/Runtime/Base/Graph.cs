    ...
    public class Graph : ScriptableObject
    {
        ...
        public void Initialize()
        {
            ...
            if (blackboard == null)
            {
                ...
                m_blackboard.hideFlags = HideFlags.HideInHierarchy;

                string path = AssetDatabase.GetAssetPath(this);

                if (!string.IsNullOrEmpty(path))
                {
                    AssetDatabase.AddObjectToAsset(m_blackboard, path);
        ...
        /// <summary>
        /// Centralized helper to flush changes and prevent serialization drops.
        /// </summary>
        ...
        public Node AddNode(Type nodeType, Vector2 position, bool undo = true)
        {
            ...
            // Force Unity to find and bind the MonoScript asset matching this type immediately
            #if UNITY_EDITOR
            string[] guids = AssetDatabase.FindAssets($"{nodeType.Name} t:MonoScript");
            foreach (string guid in guids)
            {
                ...
                {
                    // Touch/dirty the script binding to force serialization link
        ...
        {
            return (T)AddNode(typeof(T), position, undo);
        }
        ...
        public void PurgeNull()
        {
            ...
            foreach (Node node in n)
            {
                ...
                {
                    if (node.children != null && node.children.Any(c => c == null))
                    {
